...
def parse_args(log_info=True, save_log=True):
    ...
    parser.add_argument('--save_frequency', default=-1, type=int, help='Frequency of saving the model, per epoch, set to -1 to avoid this.')
    ...
    parser.add_argument('--balance', default=0.1, type=float)
